      ...
      <section className="mission bg-white text-primary p-8">
        <div className="container mx-auto">
          ...
          <p className="text-xl text-center">
            FIL-B (FIL-Builders) is a public goods team committed to helping
            builders design, unblock and implement onchain solutions on
            Filecoin’s decentralized storage network. We focus on the Filecoin
            Virtual Machine’s development.
          </p>
        </div>
      </section>
    </>
